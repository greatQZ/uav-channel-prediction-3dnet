...
class PerformanceReplayEngine:
    ...
    def run_simulation(self):
        ...
        for t in range(start_t, self.h_real.shape[0] - HORIZON):
            ...
            snr_real_current = self._sp_np_to_snr_db(sp_real_current, np_real_current) # 添加10dB偏移以匹配训练数据
            ...
            snr_reactive_input = self._sp_np_to_snr_db(sp_reactive, np_reactive) # 同样添加10dB偏移
            ...
            snr_transformer_input = self._sp_np_to_snr_db(pred_signal_power, predicted_noise_power) # 同样添加10dB偏移
