...
if __name__ == '__main__':
    channel_log_files = ['data/channel_estimates_20250917_140636_bolek_40m_5mps_autopilot.txt']
    output_mat_filename = 'data/ch_est_40m_5mps_autopilot.mat'
    output_npy_filename_sp_np = 'data/my_SP_NP_real_data_bolek_40m_5mps_autopilot.npy'
