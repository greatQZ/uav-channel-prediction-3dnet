...
# v11: [新增] 增加“理论最优吞吐量”和“信道利用率”的计算与可视化。
...
def run_visualization(sim_results):
    ...
    text_transformer = ax1.text(0.98, 0.75, '', transform=ax1.transAxes, fontsize=14, verticalalignment='top', horizontalalignment='right', bbox=dict(boxstyle='round', facecolor='blue', alpha=0.4), zorder=10)
    ...
    def update(frame):
        ...
        error_marker_r.set_data(x_errors_r, [0] * len(x_errors_r))
